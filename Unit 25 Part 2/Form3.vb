Public Class Form3
    Public Shared Teachers As New Dictionary(Of String, List(Of
    String))()
...
CheckedListBox1.Items.Add("Unit 13: Website Development") 
        CheckedListBox1.Items.Add("Unit 14: Installing and Maintaining 
Computer Hardware") 
        CheckedListBox1.Items.Add("Unit 15: Installing and Maintaining 
Computer Software") 
        CheckedListBox1.Items.Add("Unit 16: Automated Computer 
Systems") 
        CheckedListBox1.Items.Add("Unit 17: Multimedia Products 
Development") 
        CheckedListBox1.Items.Add("Unit 18: Computational Thinking") 
        CheckedListBox1.Items.Add("Unit 19: Computing in the 
Workplace") 
        CheckedListBox1.Items.Add("Unit 20: Building a Personal 
Computer") 
        CheckedListBox1.Items.Add("Unit 21: A Technology Business") 
        CheckedListBox1.Items.Add("Unit 22: Computer Security in 
Practice") 
        CheckedListBox1.Items.Add("Unit 23: Computer Systems Support in 
Practice") 
        CheckedListBox1.Items.Add("Unit 24: Software Systems 
Development") 
...
Button1.Click 
        ...
        If String.IsNullOrEmpty(teacherName) Or 
String.IsNullOrEmpty(teacherID) Then 
            MessageBox.Show("Please enter both the teacher name and 
teacher ID.") 
            Return 
        End If 
        ...
        If selectedUnits.Count = 0 Then 
            MessageBox.Show("Please select at least one unit for the 
teacher.") 
            Return 
        End If 
