...
studentTeachers.Contains(selectedTeacher) Then
                ...
                If Form4.AttendanceRecords.ContainsKey(studentID) Then
                    ...
                    If 
Form4.AttendanceRecords(studentID).ContainsKey(currentDate) Then 
                        For Each unit As String In studentData("Units")
                            If 
Form4.AttendanceRecords(studentID)(currentDate).ContainsKey(unit) Then 
                                If 
Form4.AttendanceRecords(studentID)(currentDate)(unit) = "Present" Then 
                                    attendanceStatus = 1
                                End If
                                Exit For
                            End If
...
studentLevel, studentUnits, attendanceStatus)
            End If
        Next
    End Sub
