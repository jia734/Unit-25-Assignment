...
Public Class Form2
    ...
    End Sub
    Public Class Form2
        Public Shared Students As New Dictionary(Of String, Dictionary(Of
...
MyBase.Load
        ...
        Private Sub CheckedListBox1_SelectedIndexChanged(sender As Object,
    e As EventArgs) Handles CheckedListBox1.SelectedIndexChanged
...
student.") 
        ...
        MessageBox.Show("Student record created!" & vbCrLf & 
                         ...
                         "Level: " & level & vbCrLf & 
                         "Teacher(s): " & String.Join(", ", 
selectedTeachers) & vbCrLf & 
